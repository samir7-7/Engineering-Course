...
const Hero = () => {
  return (
    ...
    >
      <div className="absolute top-0 left-0 w-full h-20 border-b-2 border-[#3B8AB8]/20 flex items-center px-8">
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          >
            ...
            <p className="text-lg sm:text-xl text-gray-600 mb-8 leading-relaxed">
              The ultimate practical training for civil engineering students and freshers —
              learn real field execution skills that no college teaches.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              >
                Enroll Now — Best Price in Market
            ...
            <div className="mt-12 grid grid-cols-3 gap-6">
              <div className="text-center">
                <div className="text-3xl font-bold text-[#3B8AB8] mb-1">500+</div>
                <div className="text-sm text-gray-600">Students Trained</div>
              </div>
              <div className="text-center">
                <div className="text-3xl font-bold text-[#3B8AB8] mb-1">4.8/5</div>
                <div className="text-sm text-gray-600">Course Rating</div>
              </div>
              <div className="text-center">
                <div className="text-3xl font-bold text-[#3B8AB8] mb-1">100%</div>
            ...
            <div className="relative bg-gradient-to-br from-gray-100 to-gray-200 rounded-2xl p-8 shadow-2xl border-4 border-white">
              ...
              <div className="bg-white rounded-xl p-6 mb-4 shadow-md">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <div>
                    ...
                    <div className="text-sm text-gray-600">Field Engineer & Instructor</div>
                  </div>
                </div>
                <div className="text-sm text-gray-700 leading-relaxed">
                  "I've worked on real construction sites and know exactly what skills you need.
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="bg-white rounded-lg p-4 shadow-sm">
                  ...
                  <div className="text-xs font-semibold text-gray-700">Drawing Reading</div>
                </div>
                <div className="bg-white rounded-lg p-4 shadow-sm">
                  <div className="text-2xl mb-1">📊</div>
                  <div className="text-xs font-semibold text-gray-700">Site Estimation</div>
                </div>
                <div className="bg-white rounded-lg p-4 shadow-sm">
                  <div className="text-2xl mb-1">👷</div>
                  <div className="text-xs font-semibold text-gray-700">Labour Management</div>
                </div>
                <div className="bg-white rounded-lg p-4 shadow-sm">
                  <div className="text-2xl mb-1">🏗️</div>
                  <div className="text-xs font-semibold text-gray-700">Site Supervision</div>
                </div>
              </div>
            </div>
      ...
      <div className="absolute bottom-0 left-0 right-0 h-4 bg-gradient-to-r from-yellow-400 via-black to-yellow-400" style={{ backgroundSize: '40px 100%', backgroundImage: 'repeating-linear-gradient(45deg, #FCD34D 0px, #FCD34D 10px, #1F2937 10px, #1F2937 20px)' }}></div>
    </section>
  );
};
