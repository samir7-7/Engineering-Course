...
const Curriculum = () => {
  ...
  return (
    <section
      ...
      style={{
        backgroundImage: `
          linear-gradient(to right, rgba(59, 138, 184, 0.04) 1px, transparent 1px),
          linear-gradient(to bottom, rgba(59, 138, 184, 0.04) 1px, transparent 1px)
        `,
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <h2 className="text-4xl sm:text-5xl font-bold text-gray-900 mb-4">
            Field Engineering{" "}
            <span className="text-[#3B8AB8]">Crash Course</span>
          </h2>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            From Fresher to Site-Ready: A comprehensive curriculum designed for
            real-world success
          </p>
        </motion.div>
        ...
        >
          ...
          <div className="relative z-10">
            ...
            <p className="text-white/90 mb-6">
              Learn at your own pace with permanent access to all course
